...
import (
	...
	qvmcontrollers "qiniu.com/qvirt/controllers/qvm"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "637a0165.qiniu.com",
	})
	if err != nil {
	...
	if err = (&qvmcontrollers.QvmReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Qvm")
		os.Exit(1)
	}
